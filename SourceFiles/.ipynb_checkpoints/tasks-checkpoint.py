...
class Task():
    ...
    def two_pulse_sequence (self, channel, time_delay, segment_pulse1 = int, segment_pulse2 = int, segment_time_delay = int):
    ...
    def three_pulse_sequence (self, channel, time_delay1, time_delay2, segment_pulse1 = int, segment_pulse2 = int, segment_pulse3 = int, segment_time_delay = int):
    ...
    def solid_task(self, inst, channel, segment_number = int):
        ...
        # singluar type of task (not compound one)
        inst.send_scpi_cmd(':TASK:COMP:DEST NEXT')
